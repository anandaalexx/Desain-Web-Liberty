...
const NavbarProfile = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full backdrop-blur-lg p-4 z-50 flex items-center justify-between font-poppins shadow-lg transition duration-300 bg-[rgba(24,50,98,0.8)] text-white"
      `}
    >
        ...
        after:duration-200 hover:after:scale-x-50`
          ...
          <li>
            <Link
              ...
              smooth={true}
              duration={700}
              className="font-normal relative hover:text-[rgba(24,50,98,0.5)] 
             after:content-[''] after:absolute after:left-0 after:right-0 
             after:bottom-[-2px] after:h-[2px] after:bg-[rgba(24,50,98,0.5)] 
             after:scale-x-0 after:origin-center after:transition-transform 
             after:duration-200 hover:after:scale-x-50"
          ...
          <li>
            <a
              href="reservasi"
              className={`px-4 py-2 rounded-3xl transition duration-300 font-norma bg-white hover:bg-gray-300 text-[#183262]`}
            >
              Reservasi
            </a>
          </li>
